...
const Invoice = forwardRef<HTMLDivElement, InvoiceProps>(({ order, settings, branding, copyLabel, accentColor, id }, ref) => {
    ...
    return (
        <div ref={ref} className="bg-white text-gray-900 w-full max-w-[210mm] mx-auto min-h-[297mm] p-8 md:p-12 relative print:p-0 print:m-0 print:w-full print:max-w-none print:h-auto border-t-[5px] print:break-after-page box-border" style={{ borderColor: accentColor || '#1e293b', fontFamily: 'Tajawal, Cairo, sans-serif' }} id={id || "print-area"} dir="rtl">
            {/* Watermark for Copy */}
            {(isCopy || copyLabel) && (
