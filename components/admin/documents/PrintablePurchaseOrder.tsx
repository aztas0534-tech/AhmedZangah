      ...
      <style>{`
        @media print {
            ...
            * { box-sizing: border-box; }
            ...
            .luxury-watermark {
                position: fixed !important; top: 30% !important; left: 50% !important;
                transform: translate(-50%, -50%) rotate(-45deg) !important;
                font-size: 40px !important; font-weight: bold !important;
                color: rgba(0,0,0,0.06) !important;
                white-space: nowrap !important; pointer-events: none !important;
                z-index: 0 !important; border: 3px solid rgba(0,0,0,0.06) !important;
            ...
            .luxury-header {
                ...
                align-items: center !important; border-bottom: 1px dashed #000 !important;
            ...
            .info-grid {
                ...
                border: 1px solid #ccc !important; padding: 4px 8px !important;
            }
            .info-group { display: flex !important; flex-direction: column !important; gap: 2px !important; }
            .info-item { display: flex !important; flex-direction: column !important; }

            .luxury-table { width: 100% !important; border-collapse: collapse !important; margin-bottom: 8px !important; }
            .luxury-table th {
                background-color: #000 !important; color: #fff !important;
                padding: 4px 6px !important; font-weight: bold !important; font-size: 11px !important;
                border: 1px solid #000 !important; text-align: right !important;
            }
            .luxury-table td {
                padding: 3px 6px !important; font-size: 11px !important; font-weight: normal !important;
                border-bottom: 1px solid #ddd !important; color: #000 !important;
            }
            ...
            .luxury-footer {
                ...
                font-size: 10px !important; color: #444 !important; padding-top: 4px !important;
            ...
            .footer-line { width: 40px !important; height: 1px !important; background-color: #000 !important; margin: 2px 0 !important; }
        }
      `}</style>
