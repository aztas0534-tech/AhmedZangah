-- ═══════════════════════════════════════════════════════════════
-- purge_order_payment v15 (FINAL):
-- Complete automated fix for "credit sale paid by mistake"
-- 1) Delete ALL payment records + journal entries
-- 2) Delete deposit (2050) party_ledger_entries from order entries
-- 3) Reclassify order journal lines: 2050 → 1200
-- 4) Re-create party_ledger_entry on 1200 (AR)
-- Result: customer deposits = clean, AR = customer still owes
-- ═══════════════════════════════════════════════════════════════
...
begin
  ...
  -- Collect ORDER journal entries + deposit lines
  ...
  -- ═══════════════════════════════════════════════════════
  -- Phase 3: Delete payment journal line dependents + lines
  -- ═══════════════════════════════════════════════════════
  if array_length(v_jl_ids, 1) > 0 then
  ...
  -- ═══════════════════════════════════════════════════════
  -- Phase 4: Clean ORDER deposit (2050) party traces
  -- ═══════════════════════════════════════════════════════
  if array_length(v_order_deposit_jl_ids, 1) > 0 then
    ...
    -- ═══════════════════════════════════════════════════════
    -- Phase 5: Reclassify 2050 → 1200 in journal_lines
    -- Then re-create party_ledger on 1200 (AR)
    -- ═══════════════════════════════════════════════════════
    if v_ar_account_id is not null then
      ...
      -- Re-create party_ledger for each order journal entry
  ...
  -- ═══════════════════════════════════════════════════════
  -- Phase 6: Delete payment journal entries
  -- ═══════════════════════════════════════════════════════
  ...
  -- ═══════════════════════════════════════════════════════
  -- Phase 8: Delete accounting_documents
  -- ═══════════════════════════════════════════════════════
  ...
  -- ═══════════════════════════════════════════════════════
  -- Phase 9: Update order (while triggers disabled)
  -- ═══════════════════════════════════════════════════════
