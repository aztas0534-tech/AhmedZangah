-- ═══════════════════════════════════════════════════════════════
-- purge_order_payment v6: Fix FK — collect doc IDs, delete at end
-- Multiple journal_entries can share same accounting_documents row
-- ═══════════════════════════════════════════════════════════════
...
begin
  ...
  -- ── Phase 1: Delete party_ledger → journal_lines → journal_entries ──
  for v_payment in
