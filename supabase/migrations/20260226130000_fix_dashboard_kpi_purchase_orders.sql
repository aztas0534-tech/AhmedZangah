...
create or replace function public.get_dashboard_kpi_v3(
  p_start_date timestamptz,
  p_end_date timestamptz,
  p_zone_id uuid default null,
  p_invoice_only boolean default false,
...
revoke all on function public.get_dashboard_kpi_v3(timestamptz, timestamptz, uuid, boolean, uuid) from public;
revoke execute on function public.get_dashboard_kpi_v3(timestamptz, timestamptz, uuid, boolean, uuid) from anon;
grant execute on function public.get_dashboard_kpi_v3(timestamptz, timestamptz, uuid, boolean, uuid) to authenticated;
