create or replace function public.diag_batch_movement_history()
returns jsonb
language plpgsql
security definer
...
revoke all on function public.diag_batch_movement_history() from public;
grant execute on function public.diag_batch_movement_history() to anon, authenticated;
