-- Fix receive_purchase_order_partial to compare with qty_base instead of quantity
...
begin
  ...
  loop
    ...
    -- THIS WAS THE BUG: Compare against qty_base safely
    select coalesce(pi.qty_base, pi.quantity, 0), coalesce(pi.received_quantity, 0), coalesce(pi.unit_cost, 0)
