-- Fix: Populate foreign currency, foreign unit cost, and FX rate in batches table during PO receipt
-- This enables correct pricing for 'FOREIGN_COST_PLUS_MARGIN' strategy
