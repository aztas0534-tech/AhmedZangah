-- Fix: column "v_method" does not exist in post_payment for cash_shifts
-- The variable v_method was never declared; the correct reference is v_pay.method
...
begin
  ...
  -- ═══════════════════════════════════════════════════════════════
  -- cash_shifts — FIX: changed v_method → v_pay.method (lines 522, 529)
  -- ═══════════════════════════════════════════════════════════════
