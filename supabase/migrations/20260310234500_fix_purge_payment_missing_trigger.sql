-- ═══════════════════════════════════════════════════════════════
-- purge_order_payment v4: Wrap ALL trigger disable/enable in
-- exception handlers so missing triggers don't cause errors
-- ═══════════════════════════════════════════════════════════════
...
begin
  ...
  -- ── Disable ALL triggers (each wrapped to handle missing triggers) ──
  ...
  -- ── 1. Delete journal entries + lines + party ledger ──
  for v_payment in
    select p.id
