...
begin
  if not exists (
    ...
    alter table public.journal_entries add column shift_id uuid references public.cash_shifts(id) on delete set null;
  end if;
end $$;

-- Drop and recreate the RPC with the shift linking logic
