-- Fix: Closing import shipment mixes currencies (Foreign Transport Cost + Base Landed Cost)
-- This causes massive journals (e.g. 70M SAR) when YER transport cost (70M YER) is added as is.
-- Fix: Convert transport_cost and supply_tax_cost to Base Currency using PO FX Rate.
...
begin
  ...
  loop
    ...
    -- landed_unit_base is already calculated in Base by calculate_shipment_landed_cost
